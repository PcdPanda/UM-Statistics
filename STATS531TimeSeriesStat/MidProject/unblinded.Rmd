...
Names: Chongdan Pan, Elizabeth Park, Liam Tsimhoni

Contributions:

Chongdan Pan: Wrote introduction, and code and explanations for sections 1, 2, 3, 4, and 6.

Elizabeth Park: Wrote explanations, equations, and the conclusion, and made revisions for many other explanations and graphs.

Liam Tsimhoni: Wrote code and explanations for section 5, added to many explanations, and wrote the in-text citations and references.
